...
| Engineering administrator | **Products & variants** | Products, variants, Tree of Parts editor (add/rename/move/remove nodes at any depth), per-node failure symptom & mode assignment |
